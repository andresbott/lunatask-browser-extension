...
export const SAVE_ACTIONS = [
  ...
  {
    id: "page-task",
    label: "Save page to task",
    action: { source: "page", target: "task" },
    contextMenuContexts: ["page", "selection"],
    popupContexts: ["page"],
    successMessage: "Saved page to task",
  },
  {
    id: "page-note",
    label: "Save page to note",
    action: { source: "page", target: "note" },
    contextMenuContexts: ["page", "selection"],
    popupContexts: ["page"],
    successMessage: "Saved page to note",
  },
  {
    id: "page-note-task",
    label: "Save page to note, create linked task",
    action: { source: "page", target: "note-with-task" },
    contextMenuContexts: ["page", "selection"],
    popupContexts: ["page"],
    successMessage: "Saved page to note and created linked task",
  },
  {
    id: "selection-task",
